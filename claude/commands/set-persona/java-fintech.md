...
- `learnings/postgresql-query-patterns.md` — PostgreSQL-specific ledger table design: DECIMAL precision, partitioning by period, partial indexes on open periods, migration safety
