...
- `~/.claude/learnings/domain-ledger-architecture.md` — three-table schema, balance composition, account-per-currency patterns (the subledger these accounts live in)
- `~/.claude/learnings/financial-applications.md` — monetary calculation safety, precision handling
- `~/.claude/learnings/postgresql-query-patterns.md` — recursive CTEs, ltree, index strategies for hierarchical queries
- `~/.claude/learnings/spring-boot.md` — JPA entity mapping patterns applicable to account hierarchy modeling
