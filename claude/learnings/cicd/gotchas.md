...
- **Related:** ~/.claude/learnings/git-patterns.md, ~/.claude/learnings/frontend/typescript-ci-gotchas.md
...
- `~/.claude/learnings/frontend/typescript-ci-gotchas.md` — pnpm/Node CI specifics (lockfile, action setup, Playwright caching, ESLint+Prettier)
