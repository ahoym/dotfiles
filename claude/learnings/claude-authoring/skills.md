...
- **Related:** ~/.claude/learnings/claude-code/skill-platform-portability.md, ~/.claude/learnings/claude-code/multi-agent-patterns.md, ~/.claude/learnings/process-conventions.md
...
- `~/.claude/learnings/claude-code/multi-agent-patterns.md` — agent-to-agent collaboration architecture (review cycles, auto-implementation patterns migrated from here)
