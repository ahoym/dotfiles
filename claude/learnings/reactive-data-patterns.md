...
- **Related:** ~/.claude/learnings/frontend/react-state-effects.md, ~/.claude/learnings/financial/order-book-pricing.md
...
- `~/.claude/learnings/frontend/react-state-effects.md` — React hooks, polling with visibility gating, localStorage migration
