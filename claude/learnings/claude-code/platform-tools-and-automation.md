...
## Skill Tool Does Not Work in `claude -p` Sessions

Auto-permitted but non-functional — returns an empty error. Read the SKILL.md and follow steps inline instead.
