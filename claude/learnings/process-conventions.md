...
- **Related:** ~/.claude/learnings/claude-code/multi-agent-patterns.md, ~/.claude/learnings/code-quality-instincts.md
...
- `~/.claude/learnings/claude-code/multi-agent-patterns.md` — agent-to-agent review cycle and mutual agreement patterns that reference the structured footnote convention defined here
