...
- **Inline analysis beats subagents for small collections:** Under ~25 files, analyze directly inline after reading. The analysis itself is fast once files are in context. Reserve per-cluster subagent fan-out for 30+ file collections.
