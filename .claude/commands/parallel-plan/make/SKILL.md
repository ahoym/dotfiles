...
- `~/.claude/commands/parallel-plan/_shared/agent-prompting.md` — Best practices for writing agent prompts (speed, landmarks, scaling, TDD, boundaries)
...
Read `~/.claude/commands/parallel-plan/_shared/agent-prompting.md` for best practices on prompt quality (speed, landmarks, scaling, TDD, boundaries). Write the structured plan to the plan file following the format below. Present it to the user for review.
