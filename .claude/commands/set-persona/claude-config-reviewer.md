...
### Skills
> Full criteria: `~/.claude/learnings/claude-authoring-skills.md`
...
### Guidelines
> Full criteria: `~/.claude/learnings/claude-authoring-guidelines.md`
...
### Learnings
> Full criteria: `~/.claude/learnings/claude-authoring-learnings.md`
...
### Personas
> Full criteria: `~/.claude/learnings/claude-authoring-personas.md`
...
### CLAUDE.md files
> Full criteria: `~/.claude/learnings/claude-authoring-claude-md.md`
