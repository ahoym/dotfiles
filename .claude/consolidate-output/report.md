...
|------|-------------|--------|--------|--------|------------|
| 1 | LEARNINGS | Remove stale internal ref | ci-cd-gotchas.md | — | MEDIUM |
| 1 | LEARNINGS | Cross-ref wiring | parallel-plans.md | multi-agent-patterns.md | MEDIUM |
